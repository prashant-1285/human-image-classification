...
class TrainingPlot(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        plt.ylabel("Loss")
        plt.legend()
        plt.savefig("/content/drive/MyDrive/Densenet/loss.jpg")
        if epoch==25:
            plt.savefig("/content/drive/MyDrive/Densenet/loss_{}.jpg".format(epoch))
        if epoch==50:
            plt.savefig("/content/drive/MyDrive/Densenet/loss_{}.jpg".format(epoch))
        if epoch==75:
            plt.savefig("/content/drive/MyDrive/Densenet/loss_{}.jpg".format(epoch))
        ...
        plt.plot(N, self.val_acc, label = "validation_acc")
        plt.title("Training Vs Validation accuracy".format(epoch))
        plt.xlabel("Epoch")
        plt.ylabel("Accuracy")
        plt.legend()
        plt.savefig("/content/drive/MyDrive/Densenet/accuracy.jpg")
        if epoch==25:
            plt.savefig("/content/drive/MyDrive/Densenet/accuracy_{}.jpg".format(epoch))
        if epoch==50:
            plt.savefig("/content/drive/MyDrive/Densenet/accuracy_{}.jpg".format(epoch))
        if epoch==75:
            plt.savefig("/content/drive/MyDrive/Densenet/accuracy_{}.jpg".format(epoch))
